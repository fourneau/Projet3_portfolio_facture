...
class __TwigTemplate_33599f695d09f06aafa91d928de90176da093915be9292177ecec2ed5cba68d1 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        Vous êtes connecté en tant que: <b>";
            ...
            echo "</b>, si vous souhaitez vous déconnecter, veuillez cliquer ci-après<a class=\"btn m-5 bg-white rounded text-center\" href=\"";
    ...
    ";
        ...
        // line 11
        echo "    <h1 class=\"h3 mb-5 font-weight-normal\">Veuillez vous connecter:</h1>
    <label class=\"username\" for=\" inputUsername\">Nom d'utilisateur</label>
    <input type=\"text\" value=\"";
        ...
        echo "\" name=\"username\" id=\"inputUsername\" class=\"form-control mb-3\" autocomplete=\"username\" required autofocus>
    <label class=\"password\" for=\"inputPassword\">Mot de passe</label>
    ...
    <input type=\"hidden\" name=\"_csrf_token\" value=\"";
        ...
        echo "\">
    <div class=\"m-5\"></div>
    <button class=\"btn bg-white rounded text-center\" type=\"submit\">
        Connexion
    </button>
</form>
<a class=\"btn bg-white rounded text-center mt-5 mb-5\" href=\"";
        // line 22
    ...
    {
        return array (  131 => 22,  122 => 16,  116 => 13,  112 => 11,  104 => 8,  101 => 7,  98 => 6,  92 => 5,  90 => 4,  86 => 2,  36 => 1,);
    }
...
<form method=\"post\">
    ...
    {% endif %} {% if app.user %}
    <div class=\"mb-3\">
        Vous êtes connecté en tant que: <b>{{ app.user.username }}</b>, si vous souhaitez vous déconnecter, veuillez cliquer ci-après<a class=\"btn m-5 bg-white rounded text-center\" href=\"{{ path('app_logout') }}\">Déconnexion</a>
    </div>
    {% endif %}
    <h1 class=\"h3 mb-5 font-weight-normal\">Veuillez vous connecter:</h1>
    <label class=\"username\" for=\" inputUsername\">Nom d'utilisateur</label>
...
<a class=\"btn bg-white rounded text-center mt-5 mb-5\" href=\"{{ path('app_forgot_password_request') }}\">Réinitialiser son mot de passe</a> {% endblock %}", "security/login.html.twig", "/home/wilder/Projet3_portfolio_facture/templates/security/login.html.twig");
    }
}
